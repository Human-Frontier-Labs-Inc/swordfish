...
export function TenantsTable({ initialTenants }: { initialTenants: Tenant[] }) {
  ...
  async function loadTenants(plan?: string, status?: string) {
    try {
      setLoading(true);
  ...
  function handlePlanChange(plan: string) {
    setPlanFilter(plan);
    loadTenants(plan || undefined, statusFilter || undefined);
  }

  function handleStatusChange(status: string) {
    setStatusFilter(status);
    loadTenants(planFilter || undefined, status || undefined);
  }
