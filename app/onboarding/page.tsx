  ...
  const renderStepContent = () => {
    switch (currentStep) {
      case 1:
        return (
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold mb-4 text-white">Welcome to SwordPhish</h2>
            ...
            <div className="grid grid-cols-2 gap-4 text-left max-w-md mx-auto text-slate-300">
      ...
      case 2:
        return (
          <div className="text-center">
            <h2 className="text-2xl font-bold mb-4 text-white">How will you use SwordPhish?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto mb-8">
              ...
              >
                <div className={`w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center ${
                  accountType === 'single' ? 'bg-blue-600' : 'bg-slate-800'
                }`}>
                  <Building2 className={`w-8 h-8 ${
                    accountType === 'single' ? 'text-white' : 'text-slate-400'
                  }`} />
                </div>
                <h3 className="text-lg font-semibold mb-2 text-white">Single Company</h3>
                <p className="text-sm text-slate-500">
                  I want to protect my own organization&apos;s email
                </p>
                <ul className="mt-4 text-sm text-left space-y-2 text-slate-300">
              ...
              >
                <div className={`w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center ${
                  accountType === 'msp' ? 'bg-purple-600' : 'bg-slate-800'
                }`}>
                  <Users className={`w-8 h-8 ${
                    accountType === 'msp' ? 'text-white' : 'text-slate-400'
                  }`} />
                </div>
                <h3 className="text-lg font-semibold mb-2 text-white">Managed Service Provider</h3>
                <p className="text-sm text-slate-500">
      ...
      case 3:
        return (
          <div className="text-center">
            <h2 className="text-2xl font-bold mb-4 text-white">Connect Your Email Provider</h2>
            <p className="text-slate-400 mb-8">
              {accountType === 'msp'
            ...
            <div className="flex flex-col gap-4 max-w-sm mx-auto">
              <button
                ...
                className="flex items-center justify-center gap-3 p-4 border-2 border-slate-700 rounded-lg hover:border-blue-500 hover:bg-blue-500/10 transition-colors text-white"
              >
                ...
                <span className="font-medium text-white">Connect Microsoft 365</span>
              </button>
              <button
                onClick={handleConnectGoogle}
                className="flex items-center justify-center gap-3 p-4 border-2 border-slate-700 rounded-lg hover:border-cyan-500 hover:bg-cyan-500/10 transition-colors text-white"
              >
                ...
                <span className="font-medium text-white">Connect Google Workspace</span>
              </button>
            </div>
          </div>
        );
      ...
      case 4:
        return (
          <div>
            <h2 className="text-2xl font-bold mb-4 text-white text-center">Configure Detection Thresholds</h2>
            ...
            <div className="max-w-md mx-auto space-y-6">
              <div>
                <div className="flex justify-between mb-2">
                  <label htmlFor="suspicious-threshold" className="font-medium text-white">Suspicious Threshold</label>
                  <span className="text-slate-400">{settings.detection.suspiciousThreshold}%</span>
                </div>
                <input
              ...
              <div>
                <div className="flex justify-between mb-2">
                  <label htmlFor="quarantine-threshold" className="font-medium text-white">Quarantine Threshold</label>
                  <span className="text-slate-400">{settings.detection.quarantineThreshold}%</span>
                </div>
                <input
              ...
              <div>
                <div className="flex justify-between mb-2">
                  <label htmlFor="block-threshold" className="font-medium text-white">Block Threshold</label>
                  <span className="text-slate-400">{settings.detection.blockThreshold}%</span>
                </div>
                <input
                  id="block-threshold"
                  type="range"
      ...
      case 5:
        return (
          <div>
            <h2 className="text-2xl font-bold mb-4 text-white text-center">Setup Notifications</h2>
            <p className="text-slate-400 mb-8 text-center">
              ...
              <div className="flex items-center justify-between p-4 border border-slate-700 rounded-lg bg-slate-800/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-slate-500">Get alerts via email</div>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-4 border border-slate-700 rounded-lg bg-slate-800/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-slate-500">Get alerts in Slack</div>
                  </div>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col">
      ...
      <div className="bg-slate-900 border-b border-slate-800 px-6 py-5">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative h-1.5 bg-slate-800 rounded-full overflow-hidden">
            <div
              className="absolute inset-y-0 left-0 bg-gradient-to-r from-blue-600 to-cyan-400 rounded-full transition-all duration-500 ease-out"
                ...
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-semibold transition-all duration-300 ${
                    step.completed
                      ...
                      : step.id === currentStep
                      ? 'bg-blue-600 text-white ring-2 ring-blue-400/40 shadow-lg shadow-blue-600/30'
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl shadow-black/40 p-8 max-w-2xl w-full transition-all duration-300">
          {renderStepContent()}
          ...
          <div className="flex justify-between mt-8 pt-6 border-t border-slate-800">
            ...
            <div className="flex gap-3">
              {currentStep !== 1 && currentStep !== 2 && currentStep !== ONBOARDING_STEPS.length && (
                <button
                  onClick={handleSkip}
                  className="px-6 py-2.5 text-slate-500 hover:text-slate-300 transition-colors"
                  disabled={loading}
                >
                  Skip
                </button>
              ...
              <button
                ...
                className={`px-6 py-2.5 text-white rounded-lg font-medium disabled:opacity-50 transition-all shadow-lg ${
